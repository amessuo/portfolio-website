      ...
      <div className={`${styles.inner} container`}>
        <RevealOnScroll variant="fade-left" className={styles.textSide}>
          ...
          <p className={styles.description}>
            ...
            explore how I can grow your business.
          </p>
          <div className={styles.contactInfo}>
            <a href="https://www.linkedin.com/in/oussamabettaieb/" target="_blank" rel="noopener noreferrer" className={styles.contactLink}>
